...
#include "GameObject/GameObjects/TestChamber.h"
#include "GameObject/GameObjects/Cube.h"
#include "GameObject/GameObjects/SignPost.h"
#include "GameObject/GameObjects/DropTrap.h"
#include "GameObject/GameObjects/Lava.h"
...
void Scene_TestChamber::ControlCamera(const double _deltaTime, const Input* _input, Configuration* _config)
{
	...
	if (!m_IsDead)
	{
		...
		m_CameraPosition.y = glm::clamp(m_CameraPosition.y, -22.0f, droptrap->GetPosition().y - 5);
	}
}
