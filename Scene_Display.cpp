...
void Scene_Display::Update(const double _deltaTime, const Input* _input, Configuration* _config)
{
...
void Scene_Display::ControlCamera(const double _deltaTime, const Input* _input, Configuration* _config)
{
...
void Scene_Display::ControlGameObjects(const double , const Input* _input, Configuration*)
{
