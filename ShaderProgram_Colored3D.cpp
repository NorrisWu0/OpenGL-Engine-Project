...
ShaderProgram_Colored3D::ShaderProgram_Colored3D(const Shader* vertex_shader, const Shader* fragment_shader)
	: ShaderProgram("ShaderProgram.3D.Colored", vertex_shader, fragment_shader)
{
}
...
void ShaderProgram_Colored3D::Render(const Configuration* config, const Mesh* mesh, const std::vector<GLfloat>* colors, const glm::mat4* Transformation) const
{
