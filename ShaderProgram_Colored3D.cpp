...
ShaderProgram_Colored3D::ShaderProgram_Colored3D(const Shader* _vertex, const Shader* _fragment)
	: ShaderProgram("ShaderProgram.3D.Colored", _vertex, _fragment) {}
...
void ShaderProgram_Colored3D::Render(const Configuration* _config, const Mesh* _mesh, const std::vector<GLfloat>* _colors, const glm::mat4* _transformation) const
{
	...
	glVertexAttribPointer(_verterPosition, 3, GL_FLOAT, GL_FALSE, 0, NULL);
	#pragma endregion
