...
ShaderProgram_Textured2D::ShaderProgram_Textured2D(const Shader* _vertex, const Shader* _fragment)
	: ShaderProgram("ShaderProgram.2D.Textured", _vertex, _fragment)
{}

ShaderProgram_Textured2D::~ShaderProgram_Textured2D() {}

void ShaderProgram_Textured2D::Render(const Configuration* _config, const Mesh* _mesh, const Texture* _texture, const glm::mat4 _translation, const glm::mat4 _rotation, const glm::mat4 _scale, const glm::mat4 _camera, const glm::mat4 projection) const
{
	...
	glVertexAttribPointer(_vertexPosition, 2, GL_FLOAT, GL_FALSE, 0, NULL);
	#pragma endregion
