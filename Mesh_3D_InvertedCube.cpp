...
Mesh_3D_InvertedCube::Mesh_3D_InvertedCube() : Mesh("Mesh.InvertedCube")
{
	...
	for (int _faceIndex = 0; _faceIndex < 6; ++_faceIndex)
	{
		...
		auto tr = { (_faceIndex * _width) + _width, _faceIndex * _height };
		auto br = { (_faceIndex * _width) + _width, (_faceIndex * _height) + _height };
		auto bl = { _faceIndex * _width, (_faceIndex * _height) + _height };
...
Mesh_3D_InvertedCube::~Mesh_3D_InvertedCube() {}
